    ...
    <script>
        function sweetalertclick() {  
            Swal({
                type: 'success',
                title: 'Eşleşme',
                text: 'Bol Şanslar Rakibiniz Belirlendi',
            }) 
        }
        function sweetalertclick2() {  
            Swal({
                type: 'error',
                title: 'Ooppss!!!!',
                text: 'Kendi Takımınızı Oluşturmadınız',
            }) 
        }
    </script>
</head>
         ...
         <div class="banner">
             <div class="takımListe">
                 ...
                 <h3 style="text-align: center; color:white; font-family: 'Trebuchet MS', Arial, 'Comic Sans MS'; border-bottom: 2px solid #d4c3c3;">Takım Listesi</h3>
                    ...
                    <h3 style="text-align: center; color:white; font-family: 'Trebuchet MS', Arial, 'Comic Sans MS'; border-bottom: 2px solid #d4c3c3; margin-top:15px;">Eşleşme Listesi</h3>

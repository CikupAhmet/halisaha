    ...
    <form id="form1" runat="server">
        <div class="wrapper">
            ...
            <div class="takimYorum">
                ...
                <div class="box">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  DataSourceID="SqlDataSource8" Width="290px">
                    <Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource8" runat="server" ConnectionString="<%$ ConnectionStrings:halisahaConnectionString %>" SelectCommand="SELECT [yorumYapanTakim], [yorumYapilanTakim], [yapilanYorum] FROM [takimYorum]"></asp:SqlDataSource>
            ...
            <div class="oyuncuYorum">
                ...
                <asp:TextBox ID="textPuan" runat="server" CssClass="yorumDalga"></asp:TextBox>
                <asp:Button ID="Button2" runat="server" CssClass="btnYorum2" Text="Yorum Yap" OnClick="Button2_Click" />
                <h3 style="text-align: center; font-family: 'Trebuchet MS', Arial, 'Comic Sans MS'; border-bottom: 2px solid #d4c3c3; ">Yorumlar</h3>
                <div class="box2">
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource9" Width="290px">
                    <Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<%$ ConnectionStrings:halisahaConnectionString %>" SelectCommand="SELECT [yorumYapanOyuncu], [yorumYapilanOyuncu], [yapilanYorum], [puan] FROM [oyuncuYorum2]"></asp:SqlDataSource>

         ...
         <div class="banner">
             <div class="takımListe">
                 ...
                 <h3 style="text-align: center; color:white; font-family: 'Trebuchet MS', Arial, 'Comic Sans MS'; border-bottom: 2px solid #d4c3c3;">Takım Listesi</h3>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" OnRowCommand="GridView1_RowCommand" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" Width="610px">
                        <Columns>
                            <asp:CommandField ShowSelectButton="True"  ControlStyle-ForeColor="Black"/>
                            <asp:BoundField DataField="takimAd" HeaderText="Takım Adı" SortExpression="takimAd" />
                            <asp:BoundField DataField="takimOlusturan" HeaderText="Takım Kaptanı" SortExpression="takimOlusturan" />
                        </Columns>
                    ...
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White" DataSourceID="SqlDataSource2" Width="610px" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                        <Columns>
                            <asp:BoundField DataField="takim1" HeaderText="1.Takım" SortExpression="takim1" />
                            <asp:BoundField DataField="takim2" HeaderText="2.Takım" SortExpression="takim2" />
                        </Columns>
                    </asp:GridView>

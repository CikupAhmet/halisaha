        ...
        <div class="wrapper">
            ...
            <div class="takimYorum">
                <div class="takimİsim">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:uyelerConnectionString %>" SelectCommand="SELECT [takimAd] FROM [takimlar]"></asp:SqlDataSource>
                ...
                <div class="box">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  DataSourceID="SqlDataSource3" Width="290px">
                    <Columns>
                        <asp:BoundField DataField="yorumYapanTakim" HeaderText="Yorum Yapan" SortExpression="yorumYapanTakim" />
                        <asp:BoundField DataField="yorumYapilanTakim" HeaderText="Yorum Yapılan" SortExpression="yorumYapilanTakim" />
            ...
            <div class="oyuncuYorum">
                <div class="oyuncuİsim">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:uyelerConnectionString %>" SelectCommand="SELECT [kullaniciAdSoyad] FROM [kullanici]"></asp:SqlDataSource>
                ...
                <h3 style="text-align: center; font-family: 'Trebuchet MS', Arial, 'Comic Sans MS'; border-bottom: 2px solid #d4c3c3; ">Yorumlar</h3>
                <div class="box2">
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource4" Width="290px">
                    <Columns>
                        <asp:BoundField DataField="yorumYapanOyuncu" HeaderText="Yorum Yapan" SortExpression="yorumYapanOyuncu" />
                        <asp:BoundField DataField="yorumYapilanOyuncu" HeaderText="Yorum Yapılan" SortExpression="yorumYapilanOyuncu" />
                        <asp:BoundField DataField="yapilanYorum" HeaderText="Yorum" SortExpression="yapilanYorum" />
                    </Columns>
                    </asp:GridView>
